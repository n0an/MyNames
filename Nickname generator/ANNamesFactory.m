...
+ (ANNamesFactory*) sharedFactory {
    ...
    dispatch_once(&onceToken, ^{
        ...
        ANNameCategory* area01cat01 = [[ANNameCategory alloc] initWithCategoryID:@"01.01" andCategoryTitle:@"Греческая мифология" andCategoryImageName:@"bg06" andCategoryBackgroundImageName:@"bg03" andAlias:@"MythGreek"];
